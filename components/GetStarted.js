...
export default function GetStarted() {
  return (
    <Link
      href="#about"
      className="bg-blue-gradient ms-2 lg:ms-[10%] -translate-y-1/3 w-[100px] h-[100px]
    ...
    >
      <span
        className="text-gradient flex items-center justify-center text-center flex-wrap 
